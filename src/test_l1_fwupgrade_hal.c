 ...
 * | Variation / Step | Description | Test Data | Expected Result | Notes |
 * | :----: | --------- | ---------- |-------------- | ----- |
 * | 01 | Invoking fwupgrade_hal_reboot_ready with pValue: valid memory location | pValue = valid memory location | Result is RETURN_OK, *pValue is 1 | Should be successful |
 */
